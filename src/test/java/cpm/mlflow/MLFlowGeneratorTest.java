...
class MLFlowGeneratorTest {
    ...
    private String getDoc() {
        return """
                ...
                prefix bndl <http://10.16.48.121:42069/api/v1/organizations/ORG/graphs/>
                prefix conn <http://10.16.48.121:42069/api/v1/connectors/>
                prefix def <https://example.org/>
                                
                entity(def:trainingTilesDataset,[prov:type = 'repr:Dataset'])
                specializationOf(def:trainingTilesDataset,conn:trainTilesConnector)
                entity(def:configFile,[def:path = "conf/config_resolved.yaml" %% xsd:string, def:runID = "6bc00f9abbd0465d865f0c1e1fa7196a" %% xsd:string, def:sha256 = "b99a126d31e7781abae1d88fe78f3979cdd2dbd3023f2d1e67db10161dadae84" %% xsd:hexBinary])
                ...
                entity(def:configFiles,[def:paths = "WyJjb25mY29uZmlnLnlhbWwiLCJjb25mY29uZmlnX3Jlc29sdmVkLnlhbWwiLCJjb25maHlkcmEueWFtbCIsImNvbmZvdmVycmlkZXMueWFtbCJd" %% xsd:base64Binary])
                endBundle
                endDocument
                """;
    }
        ...
        return """
                document
                  ...
                  bundle bndl:train
                    entity(def:trainingTilesDataset, [prov:type='repr:Dataset'])
                    specializationOf(def:trainingTilesDataset, conn:trainTilesConnector)
                    entity(def:configFile, [def:path='var:configTrainPath', def:runID='var:configTrainRunId', def:sha256='var:configTrainHash'])
                    wasDerivedFrom(def:configTrain, def:configFile, -, -, -)
                    ...
                    entity(def:logsTrain, [prov:type='repr:Log', def:path='var:logsTrainPath', def:runID='var:logsTrainRunId', def:data='var:logsTrain', def:sha256='var:logsTrainHash'])
                    activity(def:prostateTrain, -, -, [def:metrics='var:metricsTrain', def:runID='var:RunId', def:userID='var:UserId', def:startTime='var:Start', def:duration='var:Duration'])
                    wasGeneratedBy(def:logsTrain, def:prostateTrain, -)
                    wasGeneratedBy(def:trainedModel, def:prostateTrain, -)
                    wasDerivedFrom(def:trainedModel, def:trainingTilesDataset, -, -, -)
                    wasDerivedFrom(def:trainedModel, def:configTrain, -, -, -)
                    ...
                    used(def:prostateTrain, def:configTrain, -)
                    specializationOf(def:trainedModel, conn:trainedModelConnector)
                    entity(def:configFiles, [def:paths='var:configs'])
